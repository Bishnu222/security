...
const Checkout = () => {
    ...
    return (
        <div style={{ padding: '2rem 0', minHeight: '80vh', background: '#f1f5f9' }}>
            <div className="container" style={{ maxWidth: '800px' }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: '2rem' }}>
                    <div className="card">
                        <h2 style={{ marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                            <ShieldCheck color="#6366f1" /> Payment Method
                        </h2>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginBottom: '2rem' }}>
                            ...
                            >
                                <div style={{ background: '#6366f1', color: 'white', padding: '0.5rem', borderRadius: '0.5rem' }}>
                                    <CreditCard size={20} />
                                </div>
                                <div style={{ flex: 1 }}>
                                    <p style={{ fontWeight: 'bold', marginBottom: '0.125rem' }}>Stripe</p>
                                    <p style={{ fontSize: '0.8125rem', color: '#64748b' }}>Simulation</p>
                                </div>
                                {paymentMethod === 'card' && <div style={{ width: '12px', height: '12px', borderRadius: '50%', background: '#6366f1' }}></div>}
                            </div>
                            ...
                            <div
                                ...
                                style={{
                                    padding: '1.25rem',
                                    borderRadius: '0.75rem',
                                    border: `2px solid ${paymentMethod === 'esewa' ? '#6366f1' : '#e2e8f0'}`,
                                    background: paymentMethod === 'esewa' ? '#f5f3ff' : 'white',
                                    cursor: 'pointer',
                                    display: 'flex',
                                    alignItems: 'center',
                                    gap: '1rem',
                            ...
                            >
                                ...
                                <div style={{ flex: 1 }}>
                                    ...
                                    <p style={{ fontSize: '0.8125rem', color: '#64748b' }}>Nepal Gateway</p>
                                </div>
                                {paymentMethod === 'esewa' && <div style={{ width: '12px', height: '12px', borderRadius: '50%', background: '#6366f1' }}></div>}
                            </div>
                            ...
                            <div
                                ...
                                style={{
                                    padding: '1.25rem',
                                    borderRadius: '0.75rem',
                                    border: `2px solid ${paymentMethod === 'wallet' ? '#6366f1' : '#e2e8f0'}`,
                            ...
                            >
                                ...
                                <div style={{ flex: 1 }}>
                                    ...
                                    <p style={{ fontSize: '0.8125rem', color: '#64748b' }}>Balance: Rs. {user?.walletBalance?.toFixed(2) || '0.00'}</p>
                                </div>
                                {paymentMethod === 'wallet' && <div style={{ width: '12px', height: '12px', borderRadius: '50%', background: '#6366f1' }}></div>}
                            </div>
                        </div>
                        ...
                        {paymentMethod === 'esewa' && (
                            <div style={{ textAlign: 'center', padding: '1rem' }}>
                                <div style={{ marginBottom: '1.5rem', padding: '1.5rem', background: '#f0fdf4', borderRadius: '0.75rem', border: '1px solid #bbf7d0' }}>
                        ...
                        {paymentMethod === 'wallet' && (
                            <div style={{ textAlign: 'center', padding: '1rem' }}>
                                {user?.walletBalance >= total ? (
                                    ...
                                    <div style={{ padding: '1.5rem', background: '#fef2f2', borderRadius: '0.75rem', border: '1px solid #fee2e2' }}>
                                        <p style={{ color: '#dc2626', marginBottom: '1rem' }}>Insufficient balance in your wallet.</p>
                                        <button
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                        <div className="card" style={{ padding: '1.25rem' }}>
                            <h3 style={{ fontSize: '1.1rem', marginBottom: '1.25rem', fontWeight: 'bold' }}>Order Summary</h3>
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                                ...
                                <div style={{ borderTop: '1px solid #e2e8f0', marginTop: '0.5rem', paddingTop: '1rem', display: 'flex', justifyContent: 'space-between', fontWeight: 'bold', fontSize: '1.125rem' }}>
                                    <span>Total</span>
                                    <span style={{ color: '#10b981' }}>Rs. {total.toFixed(2)}</span>
                                </div>
                            </div>
                        </div>

                        <div style={{ padding: '0 0.5rem', color: '#64748b', fontSize: '0.75rem', textAlign: 'center' }}>
                            <p style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.25rem', marginBottom: '0.5rem' }}>
